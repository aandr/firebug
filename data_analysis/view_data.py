...
sensor_1_concentration = df[df.device == SENSOR_1_ID].concentration.values
sensor_2_concentration = df[df.device == SENSOR_2_ID].concentration.values
sensor_3_concentration = df[df.device == SENSOR_3_ID].concentration.values
